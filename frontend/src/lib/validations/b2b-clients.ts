...
export const b2bClientSchema = z.object({
  partner_operator_id: z.number().int().positive().optional(),
  full_name: z
    .string()
...
export type B2BClientFormData = z.infer<typeof b2bClientSchema>;

export const defaultB2BClientValues: Partial<B2BClientFormData> = {
