...
import { b2cClientSchema, B2CClientFormData } from '@/lib/validations/b2c-clients';
...
export default function EditB2CClientPage() {
  const router = useRouter();
  const params = useParams();
  const id = parseInt(params.id as string);
  const { useB2CClient, updateB2CClient, isUpdating } = useB2CClients();
  const { data: client, isLoading } = useB2CClient(id);
