...
export default function EditHotelPage() {
  ...
  useEffect(() => {
    if (hotel) {
      const itemData = hotel;
      const formData = {
        hotel_name: itemData.hotelName,
        supplier_id: itemData.supplierId ?? null,
        star_rating: itemData.starRating ? Number(itemData.starRating) : null,
        city_id: itemData.cityId,
        address: itemData.address || '',
        phone: itemData.phone || '',
        email: itemData.email || '',
        website: itemData.website || '',
        price_per_person_double: itemData.pricePerPersonDouble ? Number(itemData.pricePerPersonDouble) : null,
        single_supplement: itemData.singleSupplement ? Number(itemData.singleSupplement) : null,
        price_per_person_triple: itemData.pricePerPersonTriple ? Number(itemData.pricePerPersonTriple) : null,
        child_price_0_2: itemData.childPrice02 ? Number(itemData.childPrice02) : null,
        child_price_3_5: itemData.childPrice35 ? Number(itemData.childPrice35) : null,
        child_price_6_11: itemData.childPrice611 ? Number(itemData.childPrice611) : null,
        currency: itemData.currency || 'TRY',
        meal_plan: itemData.mealPlan ? (MEAL_PLAN_MAP[itemData.mealPlan] || itemData.mealPlan) : '',
        meal_plan_supplement: itemData.mealPlanSupplement ? Number(itemData.mealPlanSupplement) : null,
        facilities: itemData.facilities || '',
  ...
  const onSubmit = async (data: HotelFormData) => {
    try {
      ...
      const processedData = {
        ...
        cityId: data.city_id,
        starRating: data.star_rating ? Number(data.star_rating) : null,
        address: data.address || null,
        phone: data.phone || null,
        email: data.email || null,
        website: data.website || null,
        pricePerPersonDouble: data.price_per_person_double ? Number(data.price_per_person_double) : null,
        singleSupplement: data.single_supplement ? Number(data.single_supplement) : null,
        pricePerPersonTriple: data.price_per_person_triple ? Number(data.price_per_person_triple) : null,
        childPrice02: data.child_price_0_2 ? Number(data.child_price_0_2) : null,
        childPrice35: data.child_price_3_5 ? Number(data.child_price_3_5) : null,
        childPrice611: data.child_price_6_11 ? Number(data.child_price_6_11) : null,
        currency: data.currency,
        mealPlan: data.meal_plan || null,
        mealPlanSupplement: data.meal_plan_supplement ? Number(data.meal_plan_supplement) : null,
